...
import com.jfinal.weixin.demo.service.WeixinService;
...
public class WeixinMsgController extends MsgControllerAdapter {
	...
	protected void processInTextMsg(InTextMsg inTextMsg)
	{
		...
		logger.info("收到"+fromUserName+" 发送的："+content);
		OutTextMsg msg = new OutTextMsg(inTextMsg);
		msg.setContent("你给我发送了："+content);
		render(msg);
	}
	...
	protected void processInVoiceMsg(InVoiceMsg inVoiceMsg)
	{
		...
		outCustomMsg.setContent("我不能识别语音");
		render(outCustomMsg);
	}
	...
	protected void processInImageMsg(InImageMsg inImageMsg)
	{
		...
		WeixinService.saveImageToLocal(picUrl, "E:\\wxdpic",fromUserName+".png");
		OutTextMsg outTextMsg = new OutTextMsg(inImageMsg);
		outTextMsg.setContent("你发给我的图片地址是："+picUrl);
		render(outTextMsg);
	}
